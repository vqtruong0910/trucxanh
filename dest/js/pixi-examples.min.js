    ...
    bpc.initNav = function initNav() {
        ...
        bpc.generateIFrameContent = function generateIFrameContent() {
            ...
            if (!bpc.exampleValidVersions.length || bpc.exampleValidVersions.indexOf(bpc.majorPixiVersion) > -1) {
                ...
                $("#example-title").html(`${bpc.exampleTitle}<br><br><br><br><br><br><br>` + "The selected version of PixiJS does not work with this example." + "<br><br>" + `Selected version: v${bpc.majorPixiVersion}<br><br>` + `Required version: v${bpc.exampleValidVersions.toString()}<br><br><br><br><br>`);
                $(".example-frame").hide();
            }
